...
function ViewPremiumJobs() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:8081/admin/premium/getJob");
        setJobs(response.data);
        ...
        <div class="dashboard-nav">
          <div class="dashboard-inner">
            <ul data-submenu-title="Main Navigation">
              ...
              <li>
                <Link to="/BookMarkedResume">BookMarked Resumes</Link>
              </li>
              <li>
                <Link to="/JobApplicants">Job Applicants</Link>
              </li>
            </ul>
            <ul data-submenu-title="Jobs Section">
								...
								<li class="active"><Link to="/View_Premium_Jobs">View Premium Jobs</Link></li>
                      ...
                      <div className="jbr-wrap text-left border rounded">
                        <div className="cats-box mlb-res rounded bg-white d-flex align-items-center justify-content-between px-3 py-3">
                          ...
                          <div className="text-center mlb-last">
                            ...
                            <a
                              href=""
                              class="p-2 circle text-danger bg-light-danger d-inline-flex align-items-center justify-content-center ms-1"
                              onClick={(e) => {
                                e.preventDefault();
